...
if __name__ == "__main__":
    ...
    avg_density_raw = np.sum(np.array(density_matrix_raw).flatten())/np.prod(density_matrix_raw.shape)
    volume_raw = (np.prod(density_matrix_raw.shape)/np.prod(density_matrix_raw.shape))*100
    ...
    avg_density_stem = np.sum(np.array(density_matrix_stem).flatten())/np.prod(density_matrix_stem.shape)
    volume_stem = (np.prod(density_matrix_stem.shape)/np.prod(density_matrix_raw.shape))*100
    ...
    avg_density_lemma = np.sum(np.array(density_matrix_lemma).flatten())/np.prod(density_matrix_lemma.shape)
    volume_lemma = (np.prod(density_matrix_lemma.shape)/np.prod(density_matrix_raw.shape))*100
    ...
    avg_density_fix1 = np.sum(np.array(density_matrix_fix1).flatten())/np.prod(density_matrix_fix1.shape)
    volume_fix1 = (np.prod(density_matrix_fix1.shape)/np.prod(density_matrix_raw.shape))*100

    ultra_stem_fix_2 = vectorizer.normalize(sentences=preprocess.sentence_vectors ,type="ultra-stemming",fix=2)
    ultra_stem_fix_2_vector, ultra_stem_fix_2_matrix = vectorizer.vectorize(ultra_stem_fix_2)
    density_matrix_fix2 = evaluator.matrix_density(ultra_stem_fix_2_matrix)
    avg_density_fix2 = np.sum(np.array(density_matrix_fix2).flatten())/np.prod(density_matrix_fix2.shape)
    volume_fix2 = (np.prod(density_matrix_fix2.shape)/np.prod(density_matrix_raw.shape))*100
